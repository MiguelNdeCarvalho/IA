...
%estado_inicial(((3,2),[[1,3,5],[4,2,b],[6,7,8]])).
estado_inicial(((2,3),[[1,3,5],[4,2,8],[6,b,7]])).


%estado final
estado_final(((2,2),[[1,2,3],[4,b,5],[6,7,8]])).
%estado_final(((3,2),[[1,2,3],[4,5,b],[6,7,8]])).

%op(Estado_act,operador,Estado_seg,Custo)
op(((X,Y),L),desce,((X,Z),L1),1):- Y<3, Z is Y+1, substitui(V,b,(X,Z),L,L0),
                                substitui(b,V,(X,Y),L0,L1).  
op(((X,Y),L),sobe,((X,Z),L1),1):- Y>1, Z is Y-1, substitui(V,b,(X,Z),L,L0),
                                substitui(b,V,(X,Y),L0,L1).  
...
h(E, V):- h2(E, V1), h1(E, V2), max(V1, V2, V).
...
testa(Op,F):- estado_inicial(E0),op(E0,Op,F,_).
